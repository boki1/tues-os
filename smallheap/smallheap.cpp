...
std::size_t smallheap::ceil_p2(std::uintptr_t value, std::size_t p2)
{
    return value + p2 - 1 & -p2;
}

std::size_t smallheap::floor_p2(std::uintptr_t value, std::size_t p2)
{
    return value & -p2;
}

bool smallheap::is_last_block(void* bl_header)
{
...
std::optional<smallheap::chunk> smallheap::small_allocate(size_t count_pages, size_t count_chunks_in_last)
{
...
std::optional<smallheap::chunk> smallheap::tiny_allocate(size_t count_chunks)
{
...
std::optional<smallheap::chunk> smallheap::allocate(std::size_t desired_size)
{
...
// TODO:
void free(smallheap::chunk&& allocated_chunk) {}
